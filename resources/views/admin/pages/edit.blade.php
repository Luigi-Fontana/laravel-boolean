            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Modifica "{{$page->title}}"</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-8 offset-2">
                    <form action="{{route('admin.pages.update', $page->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            <fieldset>
                                <legend>Testo</legend>
                                <textarea name="body" id="body" rows="10" class="form-control">{{old('body') ?? $page->body}}</textarea>
                                @error('body')
                                    <span class="alert alert-danger">{{$message}}</span>
                                @enderror
                            </fieldset>
